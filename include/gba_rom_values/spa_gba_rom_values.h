#ifndef ROM_VALUES_SPA_H
#define ROM_VALUES_SPA_H

#include "gba_rom_values/base_gba_rom_struct.h"

const struct ROM_DATA SPA_RUBY_v0 = {
    .is_valid = true,
    ...
    .loc_readFlashSector = 0x8126078, // Known as "DoReadFlashWholeSection" in RS
...
const struct ROM_DATA SPA_SAPPHIRE_v0 = {
    .is_valid = true,
...
const struct ROM_DATA SPA_RUBY_v1 = {
    .is_valid = true,
...
const struct ROM_DATA SPA_SAPPHIRE_v1 = {
    .is_valid = true,
...
const struct ROM_DATA SPA_FIRERED_v0 = {
    .is_valid = true,
...
const struct ROM_DATA SPA_LEAFGREEN_v0 = {
    .is_valid = true,
    ...
    .loc_loadSaveSection30 = 0x815d564, // The location of the function that loads save section 30: CEReaderTool_LoadTrainerTower_r in FRLG, TryReadTrainerHill_Internal in Emerald
...
const struct ROM_DATA SPA_EMERALD_v0 = {
    .is_valid = true,
    ...
    .loc_loadSaveSection30 = 0x81d3738, // The location of the function that loads save section 30: CEReaderTool_LoadTrainerTower_r in FRLG, TryReadTrainerHill_Internal in Emerald
