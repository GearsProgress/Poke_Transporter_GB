#ifndef ROM_VALUES_GER_H
#define ROM_VALUES_GER_H

#include "gba_rom_values/base_gba_rom_struct.h"

const struct ROM_DATA GER_RUBY_v0 = {
    .is_valid = true,
...
const struct ROM_DATA GER_SAPPHIRE_v0 = {
    .is_valid = true,
...
const struct ROM_DATA GER_RUBY_v1 = {
    .is_valid = true,
...
const struct ROM_DATA GER_SAPPHIRE_v1 = {
    .is_valid = true,
...
const struct ROM_DATA GER_FIRERED_v0 = {
    .is_valid = true,
    ...
    .loc_loadSaveSection30 = 0x815d45c, // The location of the function that loads save section 30: CEReaderTool_LoadTrainerTower_r in FRLG, TryReadTrainerHill_Internal in Emerald
...
const struct ROM_DATA GER_LEAFGREEN_v0 = {
    .is_valid = true,
    ...
    .loc_loadSaveSection30 = 0x815d438, // The location of the function that loads save section 30: CEReaderTool_LoadTrainerTower_r in FRLG, TryReadTrainerHill_Internal in Emerald
...
const struct ROM_DATA GER_EMERALD_v0 = {
    .is_valid = true,
    ...
    .loc_loadSaveSection30 = 0x81d3640, // The location of the function that loads save section 30: CEReaderTool_LoadTrainerTower_r in FRLG, TryReadTrainerHill_Internal in Emerald
