...
{
    writeTable("gen_1_index_array.bin", gen_1_index_array, sizeof(gen_1_index_array));
    writeTable("gen_1_Jpn_char_array.bin", (const uint8_t*)gen_1_Jpn_char_array, sizeof(gen_1_Jpn_char_array));
    writeTable("gen_1_Eng_char_array.bin", (const uint8_t*)gen_1_Eng_char_array, sizeof(gen_1_Eng_char_array));
    writeTable("gen_1_FreGer_char_array.bin", (const uint8_t*)gen_1_FreGer_char_array, sizeof(gen_1_FreGer_char_array));
    writeTable("gen_1_ItaSpa_char_array.bin", (const uint8_t*)gen_1_ItaSpa_char_array, sizeof(gen_1_ItaSpa_char_array));
    writeTable("gen_2_Jpn_char_array.bin", (const uint8_t*)gen_2_Jpn_char_array, sizeof(gen_2_Jpn_char_array));
    writeTable("gen_2_Eng_char_array.bin", (const uint8_t*)gen_2_Eng_char_array, sizeof(gen_2_Eng_char_array));
    writeTable("gen_2_FreGer_char_array.bin", (const uint8_t*)gen_2_FreGer_char_array, sizeof(gen_2_FreGer_char_array));
    writeTable("gen_2_ItaSpa_char_array.bin", (const uint8_t*)gen_2_ItaSpa_char_array, sizeof(gen_2_ItaSpa_char_array));
    writeTable("gen_3_Jpn_char_array.bin", (const uint8_t*)gen_3_Jpn_char_array, sizeof(gen_3_Jpn_char_array));
    writeTable("gen_3_Intern_char_array.bin", (const uint8_t*)gen_3_Intern_char_array, sizeof(gen_3_Intern_char_array));
    ...
    writeTable("EVOLUTIONS.bin", EVOLUTIONS, sizeof(EVOLUTIONS));
