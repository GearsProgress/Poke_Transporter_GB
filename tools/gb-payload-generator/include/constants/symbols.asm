...
DEF ClearScreen = 0x190F
DEF PlaceString = 0x1955
DEF SoftReset = 0x1F49
DEF Serial_ExchangeBytes = 0x216F
DEF Bankswitch = 0x35D6
DEF CableClub_TextBoxBorder = 0x5AB3
DEF SaveCurrentBoxDataBank = 0x1C
DEF SaveCurrentBoxData = 0x77E2
DEF SavePartyAndDexDataBank = 0x1C
DEF SavePartyAndDexData = 0x780F
DEF RemovePokemon = 0x7B68
...
DEF wWhichPokemon = 0xCF92
DEF wRemoveMonFromBox = 0xCF95
DEF wSerialEnemyDataBlock = 0xD893
DEF wBoxCount = 0xDA80
