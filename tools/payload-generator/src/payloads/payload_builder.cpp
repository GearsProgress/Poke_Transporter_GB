...
void init_payload(byte *payload_buffer, const GB_ROM &curr_rom, int type, bool debug)
{
    ...
    else if ((curr_rom.generation == 1 && curr_rom.version == YELLOW_ID))
    {
        ...
        case GER_ID:
            ...
            z80_payload.add_bytes(7,
                                  0x4E, 0x4E, 0x4E, 0x00, 0x01, YELLOW_CUSTOM_PTR >> 0, YELLOW_CUSTOM_PTR >> 8);

            z80_payload.add_bytes(2, asm_start.place_pointer(&z80_payload), 0x00);

            z80_payload.add_bytes(35,
                                  0x4E, 0x80, 0x4E, 0x00, 0x00, 0x00, 0x00,
                                  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4E, 0x4E, 0x00, 0x00, 0x00,
                                  0x00, 0x4E, 0x4E, 0x4E, 0x4E, 0x4E, 0x4E, 0x4E, 0x4E, 0x80, 0x59, 0x50);
            break;
        case FRE_ID:
