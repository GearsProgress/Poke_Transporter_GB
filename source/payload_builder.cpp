...
byte *generate_payload(GB_ROM curr_rom, int type, bool debug)
{
    ...
    if ((curr_rom.generation == 1 && curr_rom.method == METHOD_NEWLINE))
    {
        ...
        {
            z80.add_byte(curr_rom.short_pkmn_name);
        }
        ...
        offset = 5; // Set the entrance vector - This should be changed tbh
        z80.JP(curr_rom.enter_vector_location | T_U16);
        ...
        z80.LD(B, curr_rom.SaveSAVtoSRAM1 >> 16); // Load ROM Bank
        z80.LD(HL, curr_rom.SaveSAVtoSRAM1 | T_U16);
        z80.CALL(curr_rom.Bankswitch | T_U16);
        z80.LD(B, curr_rom.SaveSAVtoSRAM1 >> 16); // Load ROM Bank
        z80.LD(HL, curr_rom.SaveSAVtoSRAM2 | T_U16);
        z80.CALL(curr_rom.Bankswitch | T_U16);
