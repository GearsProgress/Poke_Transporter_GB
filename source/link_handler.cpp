...
void LinkConnection::writeData()
{
  ...
  case WRITE_CABLE_DATA_MODE_CART:
  {
    ...
    global_memory_buffer[link_cable_array_index + 0] = (globalStateCounter >> 8) & 0xFF;
    global_memory_buffer[link_cable_array_index + 1] = (globalStateCounter >> 0) & 0xFF;
    global_memory_buffer[link_cable_array_index + 2] = enterState;
    global_memory_buffer[link_cable_array_index + 3] = (subStateCounter >> 8) & 0xFF;
    global_memory_buffer[link_cable_array_index + 4] = (subStateCounter >> 0) & 0xFF;
    global_memory_buffer[link_cable_array_index + 5] = exitState;
    ...
    if (link_cable_array_index >= 0x1000 || exitState == END)
    {
